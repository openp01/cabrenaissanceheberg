...
import { Loader2, Eye, Download, FileText, FileSearch } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';

interface PaymentInvoicePreviewDialogProps {
  invoiceId: number;
...
export default function PaymentInvoicePreviewDialog({ 
  invoiceId, 
  invoiceNumber,
  paymentId,
  children 
}: PaymentInvoicePreviewDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[900px] h-[90vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Prévisualisation du document lié au paiement
          </DialogDescription>
        </DialogHeader>
